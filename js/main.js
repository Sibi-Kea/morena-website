...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelectorAll('.needs-validation').forEach(form => {
    form.addEventListener('submit', e => {
      ...
      const subject = 'Morena enquiry: ' + field('service');
      const body = 'Name: ' + field('fullName') + '\nEmail: ' + field('workEmail') + '\nCompany: ' + field('companyName') + '\nChannel: ' + field('budget') + '\n\n' + field('message');
      window.location.href = 'mailto:info@morena.co.ls?subject=' + encodeURIComponent(subject) + '&body=' + encodeURIComponent(body);
      document.getElementById('form-status').textContent = 'Your email app will open with a draft to review and send. If it does not open, email info@morena.co.ls directly. This website has not sent your message.';
    });
  });
